...
#define NIN_VERSION_SHORT_STRING STRINGIZE(NIN_MAJOR_VERSION) "." STRINGIZE(NIN_MINOR_VERSION)

// "Special" version.
// This should only be set in custom builds, i.e. not mainline.
#define NIN_SPECIAL_VERSION			"-Slippi-dev"
